...
private:
    ...
    std::pair<std::unordered_map<int, double>, double> _column_generation(const std::vector<int>& v1, const std::vector<int>& v0, double lambda_val, double current_incumbent, std::chrono::high_resolution_clock::time_point t_start);
